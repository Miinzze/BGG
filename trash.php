    ...
    if (!hasPermission('markers_delete')) {
        ...
        try {
            ...
            if ($marker) {
                ...
                // Marker endgültig löschen (Dokumente/Bilder/PDFs bleiben erhalten! marker_documents.marker_name bleibt gespeichert)
                ...
                $message = 'Marker endgültig gelöscht. QR-Code kann wiederverwendet werden. Hinweis: Alle Dokumente bleiben im System erhalten!';
                $messageType = 'success';
            }
        } catch (Exception $e) {
            $pdo->rollBack();
...
if (isset($_POST['empty_trash'])) {
    ...
    if (!hasPermission('markers_delete')) {
        ...
        try {
            ...
            $message = "$count Marker endgültig gelöscht. Alle QR-Codes können wiederverwendet werden. Hinweis: Dokumente bleiben erhalten!";
            $messageType = 'success';
        } catch (Exception $e) {
            $pdo->rollBack();
            $message = 'Fehler: ' . $e->getMessage();

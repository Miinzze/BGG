    ...
    <div class="main-container">
        <div class="content-wrapper">
            <div class="page-header">
                <h1><i class="fas fa-user-shield"></i> Rollenverwaltung</h1>
            ...
            <div class="info-box">
                <h3><i class="fas fa-info-circle"></i> Über Rollen und Berechtigungen</h3>
                            ...
                            <?php else: ?>
                                <?php foreach ($permsByCategory as $category => $perms): ?>
                                    ...
                                    <?php foreach ($perms as $perm): ?>
                                        <div class="permission-item"><i class="fas fa-check"></i> <?= e($perm['display_name']) ?></div>
                                    <?php endforeach; ?>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </div>

                    ...
                    <form method="POST" class="marker-form" style="padding: 0;">
                        ...
                        <div class="form-group">
                            <label class="checkbox-label">
                                <input type="checkbox" name="enable_escalation" value="1" <?= ($settings['enable_escalation'] ?? 0) ? 'checked' : '' ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="warning_days" name="warning_days" min="1" max="30" value="<?= isset($settings['warning_days']) ? (int)$settings['warning_days'] : 7 ?>" required>
                            <small>Standard: 7 Tage vor Wartung</small>
                        </div>
                        
                        <div class="form-group">
                            <label for="overdue_days">Erste Eskalation (Tage nach Fälligkeit)</label>
                            <input type="number" id="overdue_days" name="overdue_days" min="1" max="14" value="<?= isset($settings['overdue_days']) ? (int)$settings['overdue_days'] : 3 ?>" required>
                            <small>Standard: 3 Tage nach Fälligkeit</small>
                        </div>
                        
                        <div class="form-group">
                            <label for="critical_days">Kritische Eskalation (Tage nach Fälligkeit)</label>
                            <input type="number" id="critical_days" name="critical_days" min="1" max="30" value="<?= isset($settings['critical_days']) ? (int)$settings['critical_days'] : 7 ?>" required>
